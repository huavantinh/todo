function submit() {
    ...
    $("#products").append('<div id="' + randId + '">' + content + '<div id="checkbox1"><input type="checkbox" onclick="checkItem(' + randId+ ') "/></div> <button onclick="deleteItem(' + randId + ')">Delete</button>' + '</div>');
    textBox.value = '';
}
...
function checkAll(){
    ...
    for(var id in products){
        ...
        checkboxid.checked=source.checked;
    }
