function submit() {
    ...
    $("#products").append('<div id="' + randId + '">' + content + '<div class="checkbox1"><input type="checkbox" id="' + randId + '" onclick="checkItem(' + randId+ ') "/></div> <button onclick="deleteItem(' + randId + ')">Delete</button>' + '</div>');
    textBox.value = '';
}
