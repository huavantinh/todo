...
function addContent(content, randId) {
  ...
  $("#products").append(
    '<div style="color: black" class="product1" id="row' + randId + '">' +
      '<div class="taskname">' + content + '</div>' +  '<div><button class="make"> Make </button></div>'+
...
let makeid = document.getElementById('randId')
console.log(makeid)
makes.addEventListener("click", movedoing)
function movedoing() {
...
// thu casch 2
// moveitem to done
let randidmake = Math.random()
console.log(randidmake) 
// makes.onclick
