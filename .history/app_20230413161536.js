...
function movedoing(event){
  ...
  '<div class="taskname">' + textitem +' <div class="checkbox-item"><input id="'  +
  '"  class="checkbox" type="checkbox"  onclick="checkItem(event)"/></div>'+'</div> <button class"delete-item" onclick="deleteItem(event)">Delete</button>' +
  "</div>")
}
