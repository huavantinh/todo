...
function makedoing(event){
  ...
  '"  class="checkbox" type="checkbox" onclick="checkidoing(event) onclick="checkItem(event)"/></div>' + '<button class"delete-item" onclick="deleteItem3(event)">Delete</button>' +
  "</div>")
  let products = document.getElementById('products')
