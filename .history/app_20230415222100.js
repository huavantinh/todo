...
function addContent2(content, randId) {
  ...
  $("#idoing").append(
    '<div style="color: black" class="product1" id="row' +
      ...
      content +
      "</div>" +
      '<div class="checkbox-item"><input class="checkbox" type="checkbox"  onclick="checkItem(event)"/></div> <button class"delete-item" onclick="deleteItem(event)">Delete</button>' +
      "</div>"
  );
}
function addContent3(content, randId) {
  ...
  $("#idone").append(
    '<div style="color: black" class="product1" id="row' +
      ...
      content +
      "</div>" +
       '<button class"delete-item" onclick="deleteItem(event)">Delete</button>' +
      "</div>"
  );
}
