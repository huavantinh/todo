...
function addContent2(content, randId) {
  ...
  $("#idoing").append(
    '<div style="color: black" class="product1" id="row' +
      ...
      content +
      "</div>" +
      '<div class="checkbox-item"><input class="checkbox" type="checkbox"  onclick="checkItem(event)"/></div> <button class"delete-item" onclick="deleteItemdoing(event)">Delete</button>' +
      "</div>"
  );
}
