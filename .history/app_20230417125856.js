...
function addContent3(content, randId) {
  ...
  $("#idone").append(
    '<div style="color: black" class="product1" id="row' +
      ...
      content +
      "</div>" +
       '<button class" productdone delete-item" onclick="deleteItemdone(event)">Delete</button>' +
      "</div>"
  );
}
...
function deleteItemdoing(event) {
  ...
  var arraypro = document.getElementsByClassName("product1"); //// cần phân biệt 3 cột, tìm arraypro của cột 2
  var div = event.currentTarget.parentNode;
  let index1 = Array.prototype.indexOf.call(arraypro, div);
...
function deleteItemdone(event) {
  ...
  var arraypro = document.getElementsByClassName("product1"); //// cần phân biệt 3 cột, tìm arraypro của cột 3
  var div = event.currentTarget.parentNode;
  let index1 = Array.prototype.indexOf.call(arraypro, div);
