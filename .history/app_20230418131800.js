...
function makecol(){
  // let producttask = document.getElementsByClassName('producttask')
  // console.log(producttask)
  // console.log(doings)
  // let productdoings = document.getElementsByClassName("productdoing")
  // console.log(productdoings)

  // idoingsave.concat(todos)
  // console.log(idoingsave)
  var products = document.getElementById("products");
  let doings = document.getElementById("idoing")
  console.log( doings)
  var products = Object.assign(doings, products);
