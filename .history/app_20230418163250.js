...
let dones = document.getElementById("doneall1")
dones.addEventListener("click", doneall)
function doneall(){
  let products = document.getElementById("producttask");
  let dones = document.getElementById("idone")
  dones.appendChild(products)
  while (products.firstChild){
